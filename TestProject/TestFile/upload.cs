...
namespace SeleniumTests
{
    ...
    public class Upload
    {
        ...
        public void TheUploadTest()
        {
            ...
            driver.FindElement(By.CssSelector("a.option_Open > input[type=\"button\"]")).Click();
            ...
            driver.FindElement(By.Id("fileToUpload")).SendKeys("C:\\Users\\liu\\Pictures\\08.png");
