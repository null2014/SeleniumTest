...
namespace SeleniumTests
{
    ...
    public class Quanxian1
    {
        ...
        [Test]
        public void TheQuanxian1Test()
        {
            driver.Navigate().GoToUrl(baseURL + "/Files/Index");
            driver.FindElement(By.XPath("//ul[@id='commandList']/li[3]/table/tbody/tr/td[2]/div/table/tbody/tr[2]/td")).Click();
            driver.FindElement(By.XPath("(//input[@value='设置权限'])[3]")).Click();
            ...
            driver.FindElement(By.XPath("//div[@id='sizcache03612259961110038']/div/div[2]/ul/li[3]")).Click();
