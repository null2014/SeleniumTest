...
namespace SeleniumTests
{
    ...
    public class Chang
    {
        ...
        public void TheChangTest()
        {
            ...
            driver.FindElement(By.XPath("(//input[@type='text'])[14]")).SendKeys("88800909");
            driver.FindElement(By.CssSelector("#window_rename > div.BorderWidth > div.boxfooter > table.table-btn > tbody > tr > td > a.btn_ok")).Click();
        }
